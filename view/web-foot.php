...
<footer class="footer">
    <div class="footer-left">
        ...
        <div class="footer-links">
            ...
            <a href="../fitness/membership.php" class="link2"><?php echo $lang['Membership'] ?></a>
            <a href="../physiotherapy/index.php" class="link3"><?php echo $lang['physio'] ?></a>
            <a href="../fitness/classes.php" class="link4"><?php echo $lang['classes'] ?></a>
            <a href="../health/senior-wellness.php" class="link5"><?php echo $lang['health'] ?></a>
        </div>
